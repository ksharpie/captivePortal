              ...
              <div class="panel panel-default">
                  <div class="panel-heading">
                      <ul class="nav nav-pills">
                          ...
                          <li role="presentation"><a href="/locations/delete/{{$location->id}}">Remove Location</a></li>
                      </ul>
                  </div>
                  <div class="panel-body">
                    <form method="POST" action="/edit-locaiton/{{$location->id}}">
                      {{ method_field('PATCH')}}
                      ...
                      <div class="form-group required">
                        ...
                        <input type="location_address" class="form-control" id="location_address" name="location_address" value="{{ $location->location_address }}">
